...
const ColorSelect = (props: SelectProps) => {
  ...
  return (
    <div className={col + " px-2"}>
      ...
      <div
        className="form-control form-control-sm rounded p-1"
        style={{ border: "1px solid #CBC8D0", backgroundColor: selectValue }}
        onClick={handleOpen}
      >
      ...
      {showPicker && (
        <SwatchesPicker
          ...
          onSwatchHover={(color, e) => console.log("color", color)}
          className="z3000"
        />
      )}
    </div>
